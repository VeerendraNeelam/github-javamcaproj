...
int n1=0;
 ...
 Connection con1=null;
          ...
          Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/HELLO","VEERU","123456");
             ...
             String str="select * from APP.register where fname='"+unm+"' and password='"+pwd+"'"; 
 ...
 {
    %>
    <form method="post" action="home1.html" name="f" target="right">
	...
	<div style="background: #0361A8; border-radius: 5px 5px 0px 0px; padding: 15px;"><span style="font-family: verdana,arial; color: #D4D4D4; font-size: 1.00em; font-weight:bold;">ADMIN AUTHENTICATED SUCESSFULLY</span></div>
